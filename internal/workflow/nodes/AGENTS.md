...
- Use `internal/workflow/nodes/codetable.Service` for CodeTable capabilities exposed to nodes. Add methods there when a node needs a new CodeTable API, then implement them in the API service adapter.
